...
RUN cargo build --release --target x86_64-unknown-linux-musl --bin itau-desafio-programacao
...
COPY --from=builder /app/target/x86_64-unknown-linux-musl/release/itau-desafio-programacao .

EXPOSE 8080
ENV RUST_LOG=info

ENTRYPOINT ["/app/itau-desafio-programacao"]
